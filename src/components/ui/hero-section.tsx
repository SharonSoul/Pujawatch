...
export function HeroSection() {
  ...
  return (
    ...
    >
      {/* Background image — adjusted focal point on mobile, pinned to right on laptops/desktops */}
      <div
        className="absolute inset-0 bg-cover bg-[position:80%_center] sm:bg-right bg-no-repeat"
