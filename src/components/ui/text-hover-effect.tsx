  ...
  return (
    ...
    >
      ...
      <text
        ...
        style={{ opacity: hovered ? 0.7 : 0, fontSize: 210, fontFamily: "var(--font-montserrat), sans-serif", stroke: "#362923" }}
      >
        {text}
      </text>
      <motion.text
        ...
        strokeWidth="1.5"
        className="fill-transparent font-bold"
        style={{ stroke: "#362923", fontSize: 210, fontFamily: "var(--font-montserrat), sans-serif" }}
      ...
      <text
        ...
        mask="url(#textMask)"
        className="fill-transparent font-bold"
        style={{ fontSize: 210, fontFamily: "var(--font-montserrat), sans-serif" }}
      >
        {text}
      </text>
    </svg>
